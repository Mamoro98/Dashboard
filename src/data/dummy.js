...
export const moroprimaryxAxis = { valueType: 'Category', title: 'Months' };
export const moroprimaryyAxis = { labelFormat: '{value}mm', edgeLabelPlacement: 'Shift', title: 'Rainfall' };
export const moroData  = [
